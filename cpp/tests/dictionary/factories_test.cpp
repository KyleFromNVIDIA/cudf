...
TEST_F(DictionaryFactoriesTest, CreateFromColumns)
{
  ...
  auto dictionary =
    cudf::make_dictionary_column(keys.release(), values.release(), cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), 0);
  cudf::dictionary_column_view view(dictionary->view());
...
TEST_F(DictionaryFactoriesTest, IndicesWithNulls)
{
  ...
  EXPECT_THROW(
    cudf::make_dictionary_column(keys.release(), indices.release(), cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), 0),
