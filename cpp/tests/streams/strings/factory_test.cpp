...
TEST_F(StringsFactoryTest, StructConstruction)
{
  ...
  auto result = cudf::make_structs_column(3, std::move(children), 0, cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), stream);
...
TEST_F(StringsFactoryTest, StructHierarchyConstruction)
{
  ...
  auto result =
    cudf::create_structs_hierarchy(3, std::move(children), 0, cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), stream);
  EXPECT_EQ(result->size(), 3);
}
