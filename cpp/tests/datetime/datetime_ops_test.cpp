...
TYPED_TEST(NonTimestampTest, TestThrowsOnNonTimestamp)
{
  ...
  cudf::column col{dtype, 0, rmm::device_buffer{}, cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), 0};
...
TYPED_TEST(TypedDatetimeOpsTest, TestEmptyColumns)
{
  ...
  cudf::column int16s{int16s_dtype, 0, rmm::device_buffer{}, cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), 0};
  cudf::column timestamps{timestamps_dtype, 0, rmm::device_buffer{}, cudf::create_null_mask(0, cudf::mask_state::UNALLOCATED), 0};
